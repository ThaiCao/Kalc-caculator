...
data class Srgb(
    ...
    internal fun asVec3(): Vec3 = Vec3(r, g, b)

    internal fun isInGamut(): Boolean = r in 0.0..1.0 && g in 0.0..1.0 && b in 0.0..1.0

    fun clamp(): Srgb = Srgb(r.coerceIn(0.0, 1.0), g.coerceIn(0.0, 1.0), b.coerceIn(0.0, 1.0))
    ...
    companion object {
        ...
        internal fun Vec3.asSrgb(): Srgb = Srgb(a, b, c)
...
data class CieLab(
    ...
    companion object {
        ...
        internal fun Vec3.asCieLab(): CieLab = CieLab(a, b, c)
...
data class Cam16(
    ...
    companion object {
        ...
        internal fun Vec3.asCam16(): Cam16 = Cam16(a, b, c)
...
data class Cam16Ucs(
    ...
    infix fun deltaE(other: Cam16Ucs): Double {
        return 1.41 * sqrt((j - other.j).pow(2) + (a - other.a).pow(2) + (b - other.b).pow(2)).pow(0.63)
    }
